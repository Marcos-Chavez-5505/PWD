    ...
    <main>
        <div class="container mt-4">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form id="peliculaForm" action="../action/formAccion_Tp2Ej4.php" method="POST" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="invalid-feedback">El guión es obligatorio.</div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="invalid-feedback">Ingrese un año válido entre 1900 y el año actual.</div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="invalid-feedback">Ingrese una duración válida (mínimo 30 minutos).</div>
                            </div>
